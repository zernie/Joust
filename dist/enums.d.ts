...
export declare const enum BnetGameType {
    BGT_UNKNOWN = 0,
    BGT_FRIENDS = 1,
...
export declare const enum BnetRegion {
...
export declare const enum Booster {
    INVALID = 0,
    CLASSIC = 1,
    GOBLINS_VS_GNOMES = 9,
...
export declare const enum CardSet {
    INVALID = 0,
    TEST_TEMPORARY = 1,
    CORE = 2,
    EXPERT1 = 3,
...
export declare const enum CardTextBuilderType {
    DEFAULT = 0,
    JADE_GOLEM = 1,
...
export declare const enum ChoiceType {
    INVALID = 0,
    MULLIGAN = 1,
    GENERAL = 2,
}
export declare const enum DeckType {
    CLIENT_ONLY_DECK = -1,
    UNKNOWN_DECK_TYPE = 0,
    NORMAL_DECK = 1,
    AI_DECK = 2,
...
export declare const enum DraftSlotType {
    DRAFT_SLOT_NONE = 0,
    DRAFT_SLOT_CARD = 1,
    DRAFT_SLOT_HERO = 2,
    DRAFT_SLOT_HERO_POWER = 3,
}
export declare const enum DungeonRewardOption {
    INVALID = 0,
    LOOT = 1,
    TREASURE = 2,
    SHRINE_TREASURE = 3,
...
export declare const enum EnchantmentVisual {
    INVALID = 0,
    POSITIVE = 1,
    NEGATIVE = 2,
    NEUTRAL = 3,
}
export declare const enum Faction {
    INVALID = 0,
    HORDE = 1,
    ALLIANCE = 2,
    NEUTRAL = 3,
...
export declare const enum GameTag {
    IGNORE_DAMAGE = 1,
...
export declare const enum GoldRewardState {
    INVALID = 0,
    ELIGIBLE = 1,
    WRONG_GAME_TYPE = 2,
    ALREADY_CAPPED = 3,
...
export declare const enum MetaDataType {
    TARGET = 0,
    META_TARGET = 0,
    DAMAGE = 1,
    META_DAMAGE = 1,
...
export declare const enum Mulligan {
    INVALID = 0,
    INPUT = 1,
    DEALING = 2,
    WAITING = 3,
...
export declare const enum MultiClassGroup {
    INVALID = 0,
    GRIMY_GOONS = 1,
    JADE_LOTUS = 2,
    KABAL = 3,
...
export declare const enum PlayReq {
    INVALID = -1,
    REQ_MINION_TARGET = 1,
...
export declare const enum PuzzleType {
    INVALID = 0,
    MIRROR = 1,
    LETHAL = 2,
    SURVIVAL = 3,
...
export declare const enum SwissDeckType {
    SWISS_DECK_NONE = 0,
    SWISS_DECK_CONQUEST = 1,
    SWISS_DECK_LAST_STAND = 2,
}
export declare const enum TavernBrawlMode {
    TB_MODE_NORMAL = 0,
    TB_MODE_HEROIC = 1,
}
export declare const enum TournamentState {
    STATE_OPEN = 1,
    STATE_LOCKED = 2,
    STATE_STARTED = 3,
    STATE_CLOSED = 4,
}
export declare const enum TournamentType {
    TYPE_UNKNOWN = 0,
    TYPE_SWISS = 1,
}
...
export declare const enum ZodiacYear {
    INVALID = -1,
    PRE_STANDARD = 0,
    KRAKEN = 1,
    MAMMOTH = 2,
...
export declare const enum Zone {
    INVALID = 0,
    PLAY = 1,
    DECK = 2,
    HAND = 3,
